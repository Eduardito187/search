            ...
            <div class="all-customers-list">
                ...
                <div class="row">
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <div v-for="data in allCustomersSender" class="accordion-item">
                            <h2 class="accordion-header" :id="data.index_id+'_index'">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" :data-bs-target="'#'+data.index_id+'_body'" aria-expanded="false" :aria-controls="data.index_id+'_body'">
                                    {{data.index}} ({{data.total_customer}})
                                </button>
                            </h2>
